...
export const siteConfig: SiteConfig = {
  // Site Information
  // [CONFIG:SITE_URL]
  site: "https://davidmcduffie.com",
  // [CONFIG:SITE_TITLE]
  title: "David McDuffie",
  // [CONFIG:HOMEPAGE_TITLE]
  homepageTitle: "",
  // [CONFIG:SITE_DESCRIPTION]
  description: "This is the personal site for David McDuffie. Welcome!",
  // [CONFIG:SITE_AUTHOR]
  author: "David McDuffie",
  ...
  navigation: {
    ...
    social: [
      {
        title: "LinkedIn",
        url: "https://www.linkedin.com/in/david-mcduffie",
        icon: "square-linkedin",
      },
      {
        title: "GitHub",
        url: "https://github.com/david-mcduffie",
        icon: "square-github",
      },
      {
        title: "Bluesky",
        url: "https://bsky.app/profile/david-mcduffie.bsky.social",
        icon: "square-bluesky",
      },
    ],
  },
